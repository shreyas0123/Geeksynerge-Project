...
const uuid = require("uuid"); // Library to generate UUIDs.
const bcrypt = require("bcrypt"); // Library for password hashing
const user = require("../models/signup"); // User model import
const forgotpassword = require("../models/forgotpassword"); // Forgot password model import
